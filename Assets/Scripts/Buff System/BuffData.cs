...
/// <summary>
/// BuffData is a class the can be used to create a basic buff on any EntityStats object.
/// This basic buff will either heal or damage the owner and experies after a certain duration.
/// </summary>

[CreateAssetMenu(fileName = "Buff Data", menuName = "2D Rogue-like/Buff Data")]
public class BuffData : ScriptableObject
{
    ...
    {
        Stats stats = Get(variant);
        return stats.damagePerSecond * stats.tickInterval;
    }

    public float GetTickHeal(int variant = 0)
    {
        Stats stats = Get(variant);
        return stats.healPerSecond * stats.tickInterval;
    }
